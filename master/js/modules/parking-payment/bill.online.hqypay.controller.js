(function () {
    angular.module('app.prepayment')
        .controller('OnlinePayHqyPayController',OnlinePayHqyPayController);
    OnlinePayHqyPayController.$inject = ['OnlinePaymentService', '$scope', 'datatablesOptions','DTColumnDefBuilder','$document','billOnlineFactory','$location'];
    'use strict';
    function OnlinePayHqyPayController(OnlinePaymentService, $scope, datatablesOptions,DTColumnDefBuilder,$document,billOnlineFactory,$location) {
        var vm = this;
        $scope.servicetype = 'parkingpay';
        $scope.payment_channel = 'hqypay';
        moment.locale('zh-cn', {
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'HH:mm:ss',
