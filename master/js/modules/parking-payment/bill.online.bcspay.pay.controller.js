(function () {
    angular.module('app.prepayment')
        .controller('OnlinePayBcspayPayController',OnlinePayBcspayPayController);
    OnlinePayBcspayPayController.$inject = ['OnlinePaymentService', '$scope', 'datatablesOptions','DTColumnDefBuilder','$document','billOnlineFactory','$location'];
    'use strict';
    function OnlinePayBcspayPayController(OnlinePaymentService, $scope, datatablesOptions,DTColumnDefBuilder,$document,billOnlineFactory,$location) {
        var vm = this;
